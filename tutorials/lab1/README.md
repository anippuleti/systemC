...
Test2 shows how the FIFO can run at different Read/Write clocks. Implementation
takes care of race between Read and write to same location. User code must 
make sure that atleast 1 element exists within FIFO before invoking method
'get_element()'.
...
speed while not loosing the accuracy. Also show how to build generic HW
